#!/usr/bin/env python3
"""Baut BrainWords.rbxlx aus den Quelldateien in src/.

Die .rbxlx-Datei kann direkt in Roblox Studio geoeffnet werden
(Datei -> Aus Datei oeffnen). Aufruf einfach mit:  python3 build_place.py
"""
...
SERVER = [
    ...
    ("ModuleScript", "MapBuilder", "server/MapBuilder.luau"),
    ("ModuleScript", "SpawnService", "server/SpawnService.luau"),
...
def build() -> None:
    ...
    # Pruefen: gueltiges XML und alle Skripte enthalten?
    tree = ET.parse(OUT)
